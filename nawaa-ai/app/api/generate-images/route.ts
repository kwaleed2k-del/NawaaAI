...
- Do NOT include text/typography in image prompts (Imagen struggles with text)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const images: { id: number; style_label: string; url?: string; base64?: string; prompt_used: string }[] = [];
