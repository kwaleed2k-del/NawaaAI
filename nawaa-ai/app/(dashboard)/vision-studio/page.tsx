        ...
        <Card className="border-[#172E1F] bg-[#0B1A0F]">
          ...
          <CardContent>
            {images.length === 0 && !generating ? (
              <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-[#172E1F] bg-[#061009] py-16">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <Skeleton key={i} className="aspect-square rounded-xl bg-[#172E1F]" />
                ))}
              </div>
            ) : (
              <div className="grid grid-cols-2 gap-4">
                {images.map((img) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center gap-2 bg-[#020B05]/80 opacity-0 transition group-hover:opacity-100">
                      <a
                        href={img.url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded-lg bg-[#0B1A0F] px-3 py-1.5 text-sm text-[#D0EBDA]"
                      >
                        Full screen
                      </a>
                      <a
                        href={img.url}
                        download
                        className="rounded-lg bg-[#006C35] px-3 py-1.5 text-sm text-white"
                      >
                        <Download className="inline h-4 w-4" />
                      </a>
                    </div>
                    <span className="absolute bottom-2 left-2 rounded bg-[#020B05]/90 px-2 py-0.5 text-xs text-[#D0EBDA]">
                      {img.style_label}
                    </span>
                  </div>
                ))}
