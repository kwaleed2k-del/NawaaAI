  ...
  return (
    <div className="relative min-h-screen bg-[#F8FBF8] overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 h-[500px] w-[500px] rounded-full bg-[#7C3AED]/[0.06] blur-[120px]" />
        ...
        <div className="absolute top-[10%] right-[15%] h-[200px] w-[200px] rounded-full bg-[#7C3AED]/[0.04] blur-[80px]" />
