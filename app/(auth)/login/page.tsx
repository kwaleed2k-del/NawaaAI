    ...
    <div className="flex min-h-screen" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <div className="relative hidden w-1/2 flex-col justify-center overflow-hidden bg-gradient-to-br from-[#020B05] via-[#0B1A0F] to-[#061A0D] lg:flex">
        ...
        <div className="relative z-10 px-12">
          ...
          >
            {locale === "ar"
              ? "منصة ذكاء اصطناعي متقدمة لإدارة الأعمال"
              : "Advanced AI platform for business management"}
          </motion.p>
        </div>
      </div>
      ...
      <div className="relative flex flex-1 flex-col justify-center bg-[#0B1A0F]/80 px-6 py-12 lg:px-16">
        ...
        >
          <div className="glass rounded-2xl p-10">
            <h1 className="text-3xl font-bold text-[#D0EBDA]">{t.welcomeBack}</h1>
            <p className="mt-2 text-base text-[#7B9E86]">{t.signInContinue}</p>
            <form onSubmit={handleSubmit} className="mt-10 space-y-5">
              <div>
                ...
                <Input
                  ...
                  required
                  className="mt-2 h-12 border-[#172E1F] bg-[#020B05]/80 text-[#D0EBDA] placeholder:text-[#7B9E86] text-base transition-all duration-300 focus:border-[#006C35] focus:shadow-[0_0_15px_rgba(0,108,53,0.15)]"
            ...
            <p className="mt-8 text-center text-base text-[#7B9E86]">
              {t.noAccount}{" "}
              <Link href="/signup" className="text-[#00A352] font-medium hover:underline">
                {t.signUp}
              </Link>
            </p>
          </div>
